...
class CommandProcessor:
    def __init__(self, manager):
        ...
        self.command_map: Dict[Command, Tuple[Callable[[Any], bool], bool]] = {
            Command.TAKE: (self.manager.handle_take, True),
            Command.EXAMINE: (self.manager.handle_examine, False),
            Command.USE: (self.manager.handle_use, True),
    ...
    def handle(self, cmd: Command, arg: Any):
    ...
    def _ensure_arg(self, cmd_name: str, arg: Any) -> Any:
        if not arg:
